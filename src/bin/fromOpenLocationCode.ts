import { isValid, fromOpenLocationCode} from '@iota/area-codes';
...
const start = async () => {
  const StarRocketPlusCode = '7QQ32GWJ+5C'
  const StarRocketIAC = fromOpenLocationCode(StarRocketPlusCode);
